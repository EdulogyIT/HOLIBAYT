    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-foreground mb-4 font-playfair">{t('propertiesForRent')}</h1>
            <p className="text-lg text-muted-foreground font-inter">{t('propertiesForRentDesc')}</p>
          </div>
          
          <PropertyFilters onFilterChange={handleFilterChange} listingType="rent" />

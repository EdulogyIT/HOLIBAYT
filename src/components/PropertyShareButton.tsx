    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        ...
        >
          ...
          {size !== "icon" && (t("share") || "Share")}
        </Button>
      </DialogTrigger>
      <DialogContent onClick={(e) => e.stopPropagation()}>
        <DialogHeader>
          <DialogTitle>{t("shareProperty") || "Share this property"}</DialogTitle>
          <DialogDescription>
            {t("sharePropertyDesc") || "Share this property with your friends and family"}
          </DialogDescription>
        </DialogHeader>

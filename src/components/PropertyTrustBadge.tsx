...
export const PropertyTrustBadge = ({ className = "" }: PropertyTrustBadgeProps) => {
  ...
  return (
    <div className={`w-full flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-3 bg-gradient-to-r from-primary/10 via-primary/5 to-transparent border border-primary/20 rounded-xl px-4 py-4 md:px-6 md:py-5 shadow-sm hover:shadow-md transition-all min-w-0 ${className}`}>
      ...
      <span className="text-xs sm:text-sm md:text-base text-muted-foreground leading-tight break-words flex-1 min-w-0 whitespace-normal mt-1 md:mt-0">

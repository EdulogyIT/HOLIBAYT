...
const allTranslations = {
  FR: {
    ...
    hostsAndGuests: "Hôtes et invités",
    settings: "Paramètres",
    backToSite: "Retour au site",
    logout: "Déconnexion",
    loggedInAs: "Connecté en tant que",
    overviewPlatformPerformance: "Aperçu des performances de votre plateforme",
    newBookings7d: "Nouvelles réservations (7j)",
    upcomingCheckins7d: "Arrivées à venir (7j)",
    activeProperties: "Propriétés actives",
    estRevenueMonth: "Revenus estimés (mois)",
    fromLastWeek: "par rapport à la semaine dernière",
    recentBookings: "Réservations récentes",
    topPerformingProperties: "Propriétés les plus performantes",
    occupancy: "occupation",
    confirmed: "Confirmé",
    pending: "En attente",
    manageBookingsGuest: "Gérez vos réservations de propriétés et communications invités",
    today: "Aujourd'hui",
    upcoming: "À venir",
    todayCheckinsCheckouts: "Arrivées et départs d'aujourd'hui",
    call: "Appeler",
    sendInfo: "Envoyer les infos",
    noCheckinsCheckoutsToday: "Aucune arrivée ou départ aujourd'hui",
    viewUpcoming: "Voir à venir",
  ...
  EN: {
    ...
    overviewPlatformPerformance: "Overview of your platform performance",
    newBookings7d: "New Bookings (7d)",
    upcomingCheckins7d: "Upcoming Check-ins (7d)",
    ...
    confirmed: "Confirmed",
    pending: "Pending",
    manageBookingsGuest: "Manage your property bookings and guest communications",
    today: "Today",
    upcoming: "Upcoming",
    todayCheckinsCheckouts: "Today's Check-ins & Check-outs",
    call: "Call",
    sendInfo: "Send Info",
    noCheckinsCheckoutsToday: "No check-ins or check-outs today",
  ...
  AR: {
    ...
    bookings: "الحجوزات",
    hostsAndGuests: "المضيفون والضيوف",
    settings: "الإعدادات",
    backToSite: "العودة للموقع",
    logout: "تسجيل الخروج",
    loggedInAs: "مسجل الدخول بصفة",
    overviewPlatformPerformance: "نظرة عامة على أداء منصتك",
    newBookings7d: "حجوزات جديدة (7 أيام)",
    upcomingCheckins7d: "وصول قادم (7 أيام)",
    activeProperties: "عقارات نشطة",
    estRevenueMonth: "الإيرادات المقدرة (شهر)",
    ...
    confirmed: "مؤكد",
    pending: "معلق",
    manageBookingsGuest: "إدارة حجوزات العقارات والتواصل مع الضيوف",
    today: "اليوم",
    upcoming: "القادم",
    todayCheckinsCheckouts: "وصول ومغادرة اليوم",
    call: "اتصال",
    sendInfo: "إرسال المعلومات",
    noCheckinsCheckoutsToday: "لا توجد وصول أو مغادرة اليوم",
    viewUpcoming: "عرض القادم",
    next30Days: "الثلاثون يوماً القادمة",
    noUpcomingReservations: "لا توجد حجوزات قادمة",
    host: "مضيف",
    hostDashboard: "لوحة مراقبة المضيف",
    calendar: "التقويم",
    listings: "الإعلانات",
